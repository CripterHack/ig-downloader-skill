...
- sync version refs to 2.4.0 across all files ([03b7d48](https://github.com/CripterHack/ig-downloader-skill/commit/03b7d48))

## [2.4.0] - 2026-07-07

### Added

- add GitHub topics for SkillsMP auto-discovery + install clawhub CLI ([312582c](https://github.com/CripterHack/ig-downloader-skill/commit/312582c))

## [2.3.1] - 2026-07-07

### Other

- add installer documentation and AI agent integration guide ([e1f14f1](https://github.com/CripterHack/ig-downloader-skill/commit/e1f14f1))
